...
// modification of https://github.com/android/compose-samples/blob/master/Jetcaster/app/src/main/java/com/example/jetcaster/util/Pager.kt
class PagerState(
        clock: AnimationClockObservable,
        currentPage: Int = 0,
        minPage: Int = 0,
        maxPage: Int = 0,
        val onChangePage: (prevPage: Int, newPage: Int) -> Unit
) {
...
class PagerScope(
    ...
    fun Modifier.scalePagerItems(
        ...
        if (selectionState == PagerState.SelectionState.Selected) {
            ...
            if (page != currentPage) {
                scale(unselectedScale, unselectedScale, Offset(center.x, center.y)) {
